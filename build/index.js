...
var doXHRReq = function (requestType, data, aSynchronous, requestURL) { return new Promise(function (resolve, reject) {
    ...
    xhrReq.onerror = function () { return reject(xhrReq.statusText); };
...
var HttpHlpr = /** @class */ (function () {
    function HttpHlpr() {
    }
    HttpHlpr.prototype.post = function (requestURL, data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, doXHRReq('POST', data, true, requestURL)];
    ...
    HttpHlpr.prototype.get = function (requestURL, data) {
        return __awaiter(this, void 0, void 0, function () {
            var e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, doXHRReq('GET', data, true, requestURL)];
                    case 1: return [2 /*return*/, (_a.sent())];
                    case 2:
                        e_2 = _a.sent();
                        return [2 /*return*/, (e_2)];
...
var getPresentation = function (presentationInput) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, httpHlpr.post(objUtil.getEnvValue('REACT_APP_PRESENTATION_END_POINT'), presentationInput)];
            case 1:
                response = _a.sent();
                ...
                return [2 /*return*/, (deepLinkDtl)];
        }
    });
}); };

var defaultWidgetContextState = {
    deepLinkDtl: {
        uuid: '',
        verifier: '',
        deeplink: '',
...
Card.defaultProps = defaultProps$1;
Card.Img = CardImg;
...
var WidgetContainer = /** @class */ (function (_super) {
    ...
    WidgetContainer.prototype.render = function () {
        ...
        return (react.createElement(Card, { className: "single-widget content-box" }, children));
    };
...
var LinkButton = /** @class */ (function (_super) {
    ...
    LinkButton.prototype.render = function () {
        ...
        return (react.createElement(Button, { href: href, variant: "link", onClick: onClick }, children));
    };
    return LinkButton;
}(react.Component));
...
var QRCode = function (_a) {
    ...
    return (react.createElement("div", { className: "qr-code" },
        react.createElement("div", { className: "bold" }, "To continue, scan this QR code"),
        react.createElement("div", null, "with your phone camera or ACME app:"),
        react.createElement(LinkButton, { onClick: handleLinkButtonClick }, "Need help scanning?"),
        showNeedHelp && (react.createElement("div", { className: "help" },
            react.createElement("div", { className: "help-item" }, "1. Install the ACME app from the app store."),
            react.createElement("div", { className: "help-item" }, "2. Open the ACME app and click \"Scan a QR code\"."),
            react.createElement("div", { className: "help-item" }, "3. Hover over the QR code."))),
        react.createElement("div", { className: "qrcode-img-wrapper" },
            react.createElement("img", { alt: "qr code", src: qrCode }))));
};
...
var ActionButton = /** @class */ (function (_super) {
    ...
    ActionButton.prototype.render = function () {
        ...
        return (react.createElement(Button, { className: className, variant: type, onClick: onClick, href: href, target: target }, children));
    };
    return ActionButton;
}(react.Component));
...
var QRCodeWidget = function () {
    ...
    return (react.createElement("div", { className: "qrcode-widget-content" },
        widgetContext.custContext.canScan
            && react.createElement(QRCode, { qrCode: widgetContext.deepLinkDtl.qrCode }),
        !widgetContext.custContext.canScan
            && (react.createElement(ActionButton, { className: "bold-label", type: "primary", target: "_blank", href: widgetContext.deepLinkDtl.deeplink }, btnLbl)),
        (widgetContext.unAuthenticatedCtx)
            && (react.createElement(LinkButton, { onClick: handleLoginLinkClick }, "Log in with your email address for more authentication options")),
        (widgetContext.custContext.phoneNo)
            && (react.createElement(LinkButton, { onClick: handleSMSLinkClick }, "Get an SMS instead")),
        (!widgetContext.custContext.phoneNo && widgetContext.custContext.emailId)
            && (react.createElement(LinkButton, { onClick: handleEmailLinkClick }, "Get an email instead"))));
};
...
var sendSms = function (phoneNo, deepLink) { return __awaiter(void 0, void 0, void 0, function () {
    var smsTmpl, smsTmplStr, smsData, response, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                smsTmpl = template || { templateText: '' };
                smsTmplStr = '';
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, httpHlpr.post(objUtil.getEnvValue('REACT_APP_SMS_END_POINT'), smsData)];
            case 2:
                response = _a.sent();
...
var SMSWidget = function () {
    ...
    return (react.createElement("div", null, smsSent
        && (react.createElement("div", { className: "sms-content" },
            smsResp
                && (react.createElement("div", null,
                    react.createElement("div", null,
                        ...
                        widgetContext.custContext.phoneNo,
                        "."),
                    react.createElement("div", { className: "bold" }, "Please click it to continue."))),
            !smsResp
            ...
            widgetContext.custContext.emailId
                && react.createElement(LinkButton, { onClick: handleEmailLinkClick }, "Get an email instead"),
            react.createElement(LinkButton, { onClick: backToQrCode }, backLinkLiteral)))));
};
...
var EmailWidget = function () {
    ...
    return (react.createElement("div", null, emailSent
        && (react.createElement("div", { className: "email-content" },
            ...
            !emailResp
                && react.createElement("div", { className: "error" },
                    ...
                    widgetContext.custContext.emailId,
                    "."),
            react.createElement(LinkButton, { onClick: handleAnotherEmailLinkClick }, "Use a different email"),
            react.createElement(LinkButton, { onClick: backToQrCode }, backLinkLiteral)))));
};
...
var WidgetHostAndController = /** @class */ (function (_super) {
    ...
    WidgetHostAndController.prototype.render = function () {
        ...
        return (react.createElement(widgetStateContext.Provider, { value: wState },
            react.createElement(WidgetContainer, null,
                (currentWidget === widgetTypes.QR_CODE) && react.createElement(QRCodeWidget, null),
                (currentWidget === widgetTypes.SMS) && react.createElement(SMSWidget, null),
                (currentWidget === widgetTypes.EMAIL) && react.createElement(EmailWidget, null))));
    };
